...
public class Wall : MonoBehaviour {
	...
	void GenerateWall()
	{
		for (int x = -16; x <= 16; x++)
		{
			Transform wall0 = Instantiate(wall.transform, new Vector3(x, 0.5f, 16), Quaternion.identity);	//creates top line of walls
			Transform wall1 = Instantiate(wall.transform, new Vector3(x, 0.5f, -16), Quaternion.identity);  //creates bottom line of walls
